            ...
            <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    ...
                    <form wire:submit="save" class="space-y-4">
                        <!-- Code -->
                        <div>
                            <label class="block mb-2.5 text-sm font-medium text-heading">Kode Kategori</label>
                            <input
                                wire:model="code"
                                name="code"
                                type="text"
                        ...
                        <!-- Name -->
                        <div>
                            <label class="block mb-2.5 text-sm font-medium text-heading">Nama Kategori</label>
                            <input
                                wire:model="name"
                                name="name"
                                type="text"
